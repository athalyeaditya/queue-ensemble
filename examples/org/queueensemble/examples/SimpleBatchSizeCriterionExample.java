...
import org.queues.ensemble.QueueException;
 ...
 *
 */
public class SimpleBatchSizeCriterionExample {

    static int entryCounter;

    public static void main(String[] r) {
        SimpleBatchAwareQueue simpleBatchAwareQueue = new SimpleBatchAwareQueue("My-Queue", 1000, new SimpleBatchSizeBufferCriterion(10));
